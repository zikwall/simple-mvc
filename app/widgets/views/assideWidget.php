            ...
            <div class="content-header-section align-parent">
                ...
                <div class="content-header-item">
                    ...
                    <a class="align-middle link-effect text-primary-dark font-w600" href="be_pages_generic_profile.html">
                        <?= \core\Core::$app->user->getUser()->username; ?>
                    </a>
                </div>
                <!-- END User Info -->
            </div>
                    ...
                    <ul class="nav-users push">
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="/public/assets/img/avatars/avatar4.jpg" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="/public/assets/img/avatars/avatar12.jpg" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="/public/assets/img/avatars/avatar13.jpg" alt="">
